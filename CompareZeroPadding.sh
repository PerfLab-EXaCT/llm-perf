#!/bin/bash 
#SBATCH --job-name="Compare Accuracy for group_by_length vs unshuffled group_by_length"   #? This is the title of the job you want to run
...
#SBATCH --time=01:00:00     #? This is the maximum time you want the job to run. If the job runs longer than this time, it will stop the job.
#SBATCH --output=CompareLR.out    #? This is the output file where you want to save the output of the job.
#SBATCH --error=CompareLR.err     #? This is the error file where you want to save the errors of the job.
...
srun --exclusive -n 1 --gres=gpu:1 python /people/hoan163/project/finetune_script.py --num_epochs 15

wait 

echo -e "\n\nno_shuffle group_by_length batching \n"
srun --exclusive -n 1 --gres=gpu:1 python /people/hoan163/project/finetune_script.py --num_epochs 15 --no_shuffle 
