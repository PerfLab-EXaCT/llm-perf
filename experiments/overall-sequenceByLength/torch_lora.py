...
if __name__ == '__main__':
    ...
    #evaluate model (.eval) more stable
    #Disable dropout layers to ensure pretrained model maintains consistency
    #Batch norm uses population statistics instead of batch statstics for stable normalization during inference
    model.eval()
    warmup = 10
    repitition = 50
    total_time = 0
