...
from TransformerLibrary.src.transformers import dependency_versions_check
from TransformerLibrary.src.transformers.utils import (
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_sentencepiece_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_tokenizers_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_sentencepiece_and_tokenizers_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_tensorflow_text_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_keras_nlp_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_vision_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_torchvision_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_timm_and_torchvision_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_pt_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_tf_objects
...
try:
    ...
    from TransformerLibrary.src.transformers.utils import dummy_flax_objects
...
if TYPE_CHECKING:
    ...
    # bitsandbytes config
    from TransformerLibrary.src.transformers.utils.quantization_config import (
        AqlmConfig,
        AwqConfig,
        BitNetConfig,
        BitsAndBytesConfig,
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_sentencepiece_objects import *
    else:
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_tokenizers_objects import *
    else:
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummies_sentencepiece_and_tokenizers_objects import *
    else:
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_tensorflow_text_objects import *
    else:
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_keras_nlp_objects import *
    else:
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_vision_objects import *
    else:
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_torchvision_objects import *
    else:
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_timm_and_torchvision_objects import *
    else:
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_pt_objects import *
    else:
        # Debugging
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_tf_objects import *
    else:
        from .generation import (
            TFForcedBOSTokenLogitsProcessor,
            TFForcedEOSTokenLogitsProcessor,
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_essentia_and_librosa_and_pretty_midi_and_scipy_and_torch_objects import *
    else:
        from .models.pop2piano import (
    ...
    try:
        ...
        from TransformerLibrary.src.transformers.utils.dummy_torchaudio_objects import *
    else:
    ...
    try:
        ...
        # Import the same objects as dummies to get them in the namespace.
        # They will raise an import error if the user tries to instantiate / use them.
        from TransformerLibrary.src.transformers.utils.dummy_flax_objects import *
    else:
        from .generation import (
            FlaxForcedBOSTokenLogitsProcessor,
            FlaxForcedEOSTokenLogitsProcessor,
