...
class OPTAttention(nn.Module):
    ...
    def forward(
        ...
        if self.trace_attn_scores:
            traced_attn_scores.append(attn_weights.view(1, bsz, self.num_heads, tgt_len, src_len).detach().cpu())
...
class OPTDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        if self.trace_mlp_activations:
            _batch, _seq_len, _hidden_size = hidden_states_shape
            traced_mlp_activations.append(hidden_states.view(1, _batch, _seq_len, -1).detach().cpu())
