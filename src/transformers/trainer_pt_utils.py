...
def get_length_grouped_indices(lengths, batch_size, mega_batch_mult=None, generator=None):
    ...
    print('\033[94m'+"\nget_length_grouped_indices is called"+'\033[0m')
...
class LengthGroupedSampler(Sampler):
    ...
    def __init__(
        ...
        generator=None, #Not needed
    ):
        
        print('\033[93m' + "\nLengthGroupedSampler called\n" + '\033[0m')
        ...
        #self.generator = generator #Not needed anymore (no more randomness)
    ...
    def __iter__(self):
        ...
        #     yield self.sorted_indices[i:i + self.batch_size] #? Another function iterates through the lists, difficult to yield
