...
from exposer.models.opt_exposer_lora_mlp import OPTForCausalLM
...
if __name__ == '__main__':
    ...
    config = get_opt_exposer_lora_mlp_config(args.model_name, mlp_block_size=args.mlp_block_size, mlp_threshold=args.mlp_threshold)
