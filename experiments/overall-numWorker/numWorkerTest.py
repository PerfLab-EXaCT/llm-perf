...
parser.add_argument('--numWorker', type=int, default=1, help='number of workers for DataLoader')
...
if __name__ == '__main__':
    ...
    print(f'--Average time: {total_time / repitition} ms, --numWorker: {args.numWorker}, --file_name: {os.path.basename(__file__)}, --model: {args.model_name}, --batch size: {args.batch_size}, --sequence length: {args.seq_len}, --data: {args.data}, --device: {args.device}')